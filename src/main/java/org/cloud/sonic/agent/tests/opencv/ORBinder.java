package org.cloud.sonic.agent.tests.opencv;
...
public class ORBinder {
    private Logger logger = new Logger();

    public FindResult getORBFindResult(File temFile, File beforeFile, boolean isDelete) throws Exception {
        ...
        ORB orb = ORB.create();
        orb.detectAndCompute(image1, image1, keyPointVector1, image11);
        orb.detectAndCompute(image2, image2, keyPointVector2, image22);
